  ...
  return (
    <div className="container-fluid">
      <div className="row">
        ...
        >
          <div>
            <p className="text-decoration-none  d-sm-inline ms-3 mt-2 d-flex text-white align-item-center">
              <i className="fs-4  bi bi-heart-pulse"></i>
              <span className="ms-1 d-none d-sm-inline fs-4 mt-2"> PHARMA</span>
            </p>
            ...
            <ul className="nav nav-pills flex-column" id="list">
              ...
              <li className="nav-item  fs-4">
                <div className="dropdown">
                  ...
                  <ul className="dropdown-menu">
                    <li>
                      <Link to={"/products"} className="dropdown-item text-dark">
                        Products List
                      </Link>
                    </li>
                    <li>
              ...
              <li className="nav-item  fs-4">
                <Link to={"/invoices"} className="nav-link  fs-5">
              ...
              <li className="nav-item  fs-4">
                <Link to={"/salereportbydate"} className="nav-link  fs-5">
                  <i className="bi bi-graph-up "></i>
                  <span className="ms-2 d-none d-sm-inline">SaleReport</span>
                </Link>
              </li>
              <li className="nav-item  fs-4">
                <Link to={"/backup"} className="nav-link  fs-5">
                  <i className="bi bi-cloud-arrow-down"></i>
                  <span className="ms-2 d-none d-sm-inline">Backup</span>
                </Link>
              </li>
              ...
              <li className="nav-item  fs-4">
                <div className="dropdown">
                  ...
                  <ul className="dropdown-menu">
                    <li>
                      <Link to={"/adduser"} className="dropdown-item text-dark">
